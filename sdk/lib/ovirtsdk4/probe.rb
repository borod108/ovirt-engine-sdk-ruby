...
module OvirtSDK4
  ...
  class Probe
    ...
    #
    # This is the Probe initializer. It receives a hash that contains
    # @param args [Hash] the arguments for the initalization for the
    #   probe class.
    # @argument args connection - an instance of OvirtSDK4::Connection
    # @argument args [PathDetector] - an instance of a class that can
    #   recevie a connection and return the servers api path.
    # @argument args version_detector - an instance of a class that
    ...
    # It returns an array of supported version strings.
  ...
  class PathDetector
    ...
    def detect(connection)
      API_PATH_CANDIDATES.each do |path|
        ...
        raise OvirtSDK4::Error('Unauthorized') if res.code == 401
      end
    end
  ...
  class VersionDetector
    ...
    # The methods below are based on headers oVrit returns depending on the API
